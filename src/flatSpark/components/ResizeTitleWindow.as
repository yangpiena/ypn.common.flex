...
{
	import flatSpark.events.MaxEvent;
	import flatSpark.events.MinEvent;
	import flatSpark.skins.ResizeTitleWindowSkin;
	...
	public class ResizeTitleWindow extends TitleWindow
	{
		...
		override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void{
			...
			setStyle("skinClass", Class(flatSpark.skins.ResizeTitleWindowSkin));
		}
		...
		protected function maxButton_clickHandler(event:MouseEvent):void
		{
			...
			if(!isWinExpanded){
				...
				if(currentWinState=="NORMAL"){
					...
					currentWinState = "MAX";
					isWinExpanded = true ;
					this.maxButton.setStyle("skinClass" ,Class(flatSpark.skins.ResizeTitleWindowRestoreButtonSkin));
